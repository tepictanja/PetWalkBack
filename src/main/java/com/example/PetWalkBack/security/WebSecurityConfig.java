package com.example.PetWalkback.security;

import com.example.PetWalkback.security.models.AuthorizationRules;
import com.example.PetWalkback.security.models.Rule;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    private HttpSecurity createAuthorizationRules(HttpSecurity http) throws Exception {
        ...
        interceptor = interceptor.antMatchers(HttpMethod.POST, "/login").permitAll().antMatchers(HttpMethod.POST, "/sign-up").permitAll()
                                .antMatchers(HttpMethod.GET,"/mjesta").permitAll();
