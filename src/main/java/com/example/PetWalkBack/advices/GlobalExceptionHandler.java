package com.example.PetWalkback.advices;
...
import com.example.PetWalkback.exceptions.HttpException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException e, HandlerMethod handlerMethod) {
